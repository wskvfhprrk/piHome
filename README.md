...
![1615944042789](1615944042789.png)

树莓派4B

![1615944207053](1615944207053.png)

树莓派zero w 

​	![1615944708603](1615944708603.png)

串口转射频信号（315和433）

![1615944840605](1615944840605.png)

红外解码模块，为什么不使用红包模块——新版本不支持红外io模块读取，详见：https://www.cnblogs.com/punkrocker/p/11223137.html

![1615947793440](1615947793440.png)

ch340G USB TO TTL，这种推荐使用，我现在就是用的这种，不建议使用下种：

![1615945539565](1615945539565.png)
...
![1615950915885](1615950915885.png)
...
![1615958828392](1615958828392.png)
...
![1615959297519](1615959297519.png)
...
![1615970883112](1615970883112.png)
...
我们使用的是`2021-01-11-raspios-buster-armhf-lite`版本，它是不含桌面版，可以到其官网下载，初次玩树莓派的，官方建议烧录含桌版的（`full`）。使用烧录软件`balenaEtcher`：![1615972482641](1615972482641.png)

官网都可以下载，然后烧录系统，打开软件根据提示一步步进行：![1615972587893](1615972587893.png)

然后点击flash时行烧录：

![1615972640102](1615972640102.png)

烧录完后，不要拨sd卡，加入wifi连接 ssid和密码，打开网站：![1615972823504](1615972823504.png)
...
![1615973188242](1615973188242.png)
...
![1615974332555](1615974332555.png)
...
![1616030370751](1616030370751.png)

![1616030460495](1616030460495.png)

按上下键，空格表示 选择到：

![1616030527488](1616030527488.png)

![1616030560970](1616030560970.png)

选择：`en_GB.UTF-8``zh_CN GBK`和`zh_CN UTF-8`三个后按tab键选择`ok`,再次按tab选择OK，回车设定完毕

![1616030792792](1616030792792.png)

#### 2）设置时区

同样一步步选择：

![1616030866417](1616030866417.png)

![1616031042372](1616031042372.png)

选择亚洲：

![1616031088661](1616031088661.png)

tab制表符到ok到地区选择，在键盘英文情况下按s键——找上海（Shanghai）后确定，时间设置成功东八区

![1616031244298](1616031244298.png)

系统时间设置成功：

![1616031437257](1616031437257.png)

#### 3)更新系统

##### 一种方式可以使用设置界面选择：

![1616031353448](1616031353448.png)	直接回车更新系统；
...
![1616033238393](1616033238393.png)
...
![1616034364516](1616034364516.png)
...
![1616034517845](1616034517845.png)
...
![1616035152622](1616035152622.png)
...
![1616036765845](1616036765845.png)

点周XFTP:

![1616036820282](1616036820282.png)

直上传打包文件：

![1616036865100](1616036865100.png)
...
![1616038150159](1616038150159.png)

出现这些表示项目后台启动了，再看日志，目录在logs下

![1616038240769](1616038240769.png)

查看日志文件：

**仅能使用cat命令**

![1616038308178](1616038308178.png)

项目正常启动

设置参数数据（截止目前系统还不太完善，逐步升级，很多接口没有时间写，慢慢完善），把上面数据结构表，使用csv格式保存，使用postman把其数据能过接口写进系统中（使用swagger测试会出问题）：

![1616038618052](1616038618052.png)
...
![1616039201128](1616039201128.png)
...
![1616039312763](1616039312763.png)
